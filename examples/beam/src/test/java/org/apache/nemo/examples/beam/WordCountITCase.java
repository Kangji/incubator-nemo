...
import org.apache.nemo.compiler.optimizer.policy.ExplorationPolicy;
...
public final class WordCountITCase {
  ...
  @Test(timeout = ExampleTestArgs.TIMEOUT)
  public void testExplorationPolicy() throws Exception {
    JobLauncher.main(builder
      .addResourceJson(executorResourceFileName)
      .addJobId(WordCountITCase.class.getSimpleName() + "_exploration")
      .addMaxTaskAttempt(Integer.MAX_VALUE)
      .addOptimizationPolicy(ExplorationPolicy.class.getCanonicalName())
      .build());
  }
}
