...
public final class IRDAG implements DAGInterface<IRVertex, IREdge> {
   ...
   * @param incomingEdgesOfOriginalVertices   edges going to be dropped out of dag
   * @param outgoingEdgesOfOriginalVertices   edges going to be dropped out of dag
   * @param edgesWithSplitterVertex           new edges
   */
