 ...
 */
public final class LocationSharesProperty extends ExecutionProperty<Map<String, Integer>> {
  /**
   * Default constructor.
   * @param value the map from location to the number of TaskGroups that must be executed in that location
   */
  public LocationSharesProperty(final Map<String, Integer> value) {
    super(Key.LocationShares, value);
  }
   ...
   */
  public static LocationSharesProperty of(final Map<String, Integer> value) {
