...
import edu.snu.nemo.common.ir.vertex.executionproperty.SourceLocationAwareProperty;
...
@ThreadSafe
@DriverSide
public final class SourceLocationAwareSchedulingPredicate implements SchedulingPredicate<SourceLocationAwareProperty> {
  ...
  public boolean testSchedulability(final Task task,
                                    final SourceLocationAwareProperty property,
    ...
    return sourceLocations.contains(executorRepresenter.getNodeName());
  }
}
