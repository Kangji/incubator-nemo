...
/**
 * Tests {@link MinOccupancySchedulingPolicy}
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ExecutorRepresenter.class, Task.class})
public final class MinOccupancySchedulingPolicyTest {
  ...
  public void testRoundRobin() {
    final SchedulingPolicy schedulingPolicy = new MinOccupancySchedulingPolicy();
