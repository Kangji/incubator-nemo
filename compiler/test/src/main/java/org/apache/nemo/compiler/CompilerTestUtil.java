...
public final class CompilerTestUtil {
  ...
  public static IRDAG compileEDGARDAG() throws Exception {
    final String input = ROOT_DIR + "/examples/resources/inputs/test_input_edgar";
    final String windowType = "fixed";
    final String main = "org.apache.nemo.examples.beam.EDGARDocumentSuccessRate";
    final String output = ROOT_DIR + "/examples/resources/inputs/test_output";
    ...
    final ArgBuilder edgarArgBuilder = new ArgBuilder()
      ...
      .addUserMain(main)
      .addUserArgs(input, windowType, output)
