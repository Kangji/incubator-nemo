  ...
  public void testMatchingDAGs() {
    ...
    while (originalVertices.hasNext() && processedVertices.hasNext()) {
      ...
      if (processedVertex.isUtilityVertex()) {
        ...
        assertEquals(originalVertex.getClass(), processedVertex.getClass());
        if (originalVertex instanceof OperatorVertex && processedVertex instanceof OperatorVertex) {
          assertEquals(((OperatorVertex) originalVertex).getTransform().getClass(),
            ((OperatorVertex) processedVertex).getTransform().getClass());
        }
      }
    }
