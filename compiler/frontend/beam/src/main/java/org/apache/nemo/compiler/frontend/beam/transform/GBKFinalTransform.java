...
public final class GBKFinalTransform<K, InputT, OutputT>
  ...
  public GBKFinalTransform(final Coder inputcoder,
    ...
    super(null, /* doFn */
      ...
      Collections.<String, PCollectionView<?>>emptyMap()); /* Not considering side inputs at this moment */
...
//      Thread.currentThread().getId(), (System.currentTimeMillis() - st));
   ...
   */
  final class GBKWOutputCollector extends AbstractOutputCollector<WindowedValue<KV<K, OutputT>>> {
